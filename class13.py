verify_nine_numb_cpf = "746.824.890"
multipliers_per_digit = [10, 9, 8, 7, 6, 5, 4, 3, 2]

verify_nine_numb_cpf_has_dot = verify_nine_numb_cpf.find(".")
...
first_digit_cpf = sum_of_multipliers_per_digit > 9 if 0 else sum_of_multipliers_per_digit
